    ...
    types: [
        {
            value: 'build',
            name:
                'build      Changes that affect the build system (involving scripts, configurations or tools) or external dependencies',
        },
        {
            value: 'ci',
        ...
        },
        {
            value: 'refactor',
            name:
                'refactor   Development changes related to modifying the codebase, which neither adds a feature nor fixes a bug',
        },
        {
            value: 'revert',
